...
<h2 class="sub-header"><a href="ad-admin.php">Admin</a> > Users' Statistics</h2>
...
$query0 = "SELECT u.id, u.first_name, u.last_name, COUNT(u.id) AS no_of_rides, SUM(r.cost) AS total_spent, SUM(r.cost)/COUNT(u.id) AS average_spent 
FROM users u, proposal p, ride r 
WHERE u.id=p.riderid AND r.rideid=p.rideid
